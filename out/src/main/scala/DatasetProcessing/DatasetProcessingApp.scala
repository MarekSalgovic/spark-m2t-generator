...
object DatasetProcessingApp {
	...
	val TV_conf = """[]"""
	val TV_arguments = """[org.eclipse.emf.ecore.impl.DynamicEObjectImpl@6c5ddccd (eClass: org.eclipse.emf.ecore.impl.EClassImpl@36dce7ed (name: ProgramArgument) (instanceClassName: null) (abstract: false, interface: false))]"""
	val TV_master = """\"local[*]\""""
