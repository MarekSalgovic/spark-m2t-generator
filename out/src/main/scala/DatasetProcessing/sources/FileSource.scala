...
class FileSource(spark: SparkSession) {
	...
	val TV_dataType = """org.eclipse.uml2.uml.internal.impl.DataTypeImpl@7db0565c (name: Abbr, visibility: <unset>) (isLeaf: false, isAbstract: false, isFinalSpecialization: false)"""
	val TV_priority = """5"""
